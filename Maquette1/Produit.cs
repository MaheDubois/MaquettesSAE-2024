...
namespace Maquette1
{
    ...
    {
        int num_produit, num_categorie, id_couleur;
        ...
        public Produit(int num_produit, int num_categorie, string nom_produit, string taille_produit, string description_produit, double prix_vente, int id_couleur)
        {
        ...
        public static ObservableCollection<Produit> Read()
        {
            ...
            foreach (DataRow res in dt.Rows)
            {
                ...
                res["nom_produit"].ToString(), res["taille_produit"].ToString(), res["description_produit"].ToString(), double.Parse(res["prix_vente"].ToString()), int.Parse(res["id_couleur"].ToString()));
